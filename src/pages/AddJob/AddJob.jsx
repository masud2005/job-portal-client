...
const AddJob = () => {
    ...
    const handleAddJob = (e) => {
        ...
        // console.log(newJob, min, max, currency);
    ...
    return (
        <div>
            <div className='container mx-auto bg-gray-100 my-10 md:p-10 rounded'>
                ...
                <form onSubmit={handleAddJob} className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        <select defaultValue='Pick a Job Type' className='select input-bordered' name='job-type'>
                    ...
                    <div className="form-control">
                        ...
                        <select defaultValue="Pick a Job Field" className="select select-ghost w-full bg-white input-bordered" name='job-field'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 items-end'>
                        ...
                        <div className="form-control">  
                            <select defaultValue="Currency" name="currency" className="select select-ghost w-full bg-white input-bordered">
